...
class AppViewModel: ViewModel() {
    ...
    fun insertCard(cardEntity: CardEntity){viewModelScope.launch {repository.insertCard(cardEntity)}}

    fun deleteCard(cardEntity: CardEntity){viewModelScope.launch {repository.deleteCard(cardEntity)}}
    ...
    fun insertList(listEntity: ListEntity){viewModelScope.launch {repository.insertList(listEntity)}}

    fun deleteList(listEntity: ListEntity){viewModelScope.launch {repository.deleteList(listEntity)}}

    fun updateList(listEntity: ListEntity){viewModelScope.launch {repository.updateList(listEntity)}}
    ...
    fun insertTag(tagEntity: TagEntity){viewModelScope.launch {repository.insertTag(tagEntity)}}

    fun deleteTag(tagEntity: TagEntity){viewModelScope.launch {repository.deleteTag(tagEntity)}}

    fun updateTag(tagEntity: TagEntity){viewModelScope.launch {repository.updateTag(tagEntity)}}
    ...
    fun insertUser(userEntity : UserEntity){viewModelScope.launch {repository.insertUser(userEntity)}}

    fun deleteUser(userEntity : UserEntity){viewModelScope.launch {repository.deleteUser(userEntity)}}

    fun updateUser(userEntity : UserEntity){viewModelScope.launch {repository.updateUser(userEntity)}}
